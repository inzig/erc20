...
class MembersController extends Controller
{
    ...
    public function teamMembers(Request $request)
    {
        ...
        $team_members = Member::query()->where('title','Team');
        ...
        $team_members->get()->each(function ($member) use ($data) {
            $data->push([
                ucfirst($member->name),
                $member->designation,
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['type' => 'success', 'message' => 'Team Member has been updated']);
    }
    ...
    public function edit($id)
    {
        ...
        return response(view('admin.members.edit', compact('member')))->header('title', 'Update ' . ucfirst($member->name) . '  information.');
    }
    ...
    public function create()
    {
        ...
        return response(view('admin.members.edit', compact('member')))->header('title', 'Add new team member');
    }
    ...
    public function add(Request $request)
    {
        ...
        return response()->json(['type' => 'success', 'message' => 'Team member has been added.']);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['type' => 'success', 'message' => 'Team member has been  deleted successfully.']);
    }
}
