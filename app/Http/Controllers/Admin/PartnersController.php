...
class PartnersController extends Controller
{
    ...
    public function partnersList(Request $request)
    {
        ...
        $partners = Partner::query()->where('title','Partner');;
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['type' =>  'success' , 'message' => 'Partner has been updated']);
    }
    ...
    public function edit($id)
    {
        ...
        return response(view('admin.partner.edit', compact('partner')))->header('title', 'Update ' . ucfirst($partner->name) . '  partner.');
    }
    ...
    public function create()
    {
        ...
        return response(view('admin.partner.edit', compact('partner')))->header('title', 'Add new partner');
    }
    ...
    public function add(Request $request)
    {
        ...
        return response()->json(['type' => 'success', 'message' => 'Partner has been added.']);
    }
    public function destroy($id)
    {
        ...
        return response()->json(['type' => 'success', 'message' => 'Partner has been deleted successfully.']);
    }
}
