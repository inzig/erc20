...
class ResendVerificationEmail extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Please verify your account by clicking activate button.')
            ->action('Activate', route('user.activate', ['token' => $this->activation->token]))
            ->line('Remember to remove !');
    }
}
