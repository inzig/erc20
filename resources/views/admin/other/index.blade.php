...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                ...
                <a href="{{ route('admin.other') }}">Faq</a>
            </li>
        </ul>
    </div>
    ...
    <div>
        <div class="note note-info">
            <p> Admin must add or update faq </p>
        </div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Faq</span>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn green"><i class="fa fa-send"></i> <span>Update Faq</span></button>
                        </div>
                    </form>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            $datatable.on('click', '.row-actions a[data-action]', function () {
                ...
                var url = '/admin/other/edit/'+$e.parents('.row-actions').data('action');

                    if ($type === 'edit')
                    axios.get(url).then(function (r) {
                        $modal.find('button[type="submit"] span').html('Update faq');
                ...
                if($type === 'delete') {
                    var url = '/admin/other/'+$e.parents('.row-actions').data('action');
            ...
            $('.add-address').click(function () {
                var $modal = $('#basicModal');
                var url = '/admin/other/create';
                axios.get(url).then(function (r) {
                    $modal.find('button[type="submit"] span').html('Add new faq ');
                    $modal.find('.modal-title').html(r.headers.title);
                    $modal.find('.modal-body').html(r.data);
                    $modal.find('form').attr('action', '/admin/other/add');
