...
@section('content')
    <h1 class="page-title"> Admin Dashboard
        <small>add or update advisor members</small>
    </h1>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                ...
                <a href="{{ route('admin.advisor') }}">Members</a>
            </li>
        </ul>
    </div>
    ...
    <div>
        <div class="note note-info">
            <p> Admin must add or update his Advisors members </p>
        </div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Advisors Members</span>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn green"><i class="fa fa-send"></i> <span>Update Advisor</span></button>
                        </div>
                    </form>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            $datatable.on('click', '.row-actions a[data-action]', function () {
                ...
                var url = '/admin/advisor/edit/' + $e.parents('.row-actions').data('action');

                if ($type === 'edit')
                    axios.get(url).then(function (r) {
                        $modal.find('button[type="submit"] span').html('Update advisor member');
                ...
                if($type === 'delete') {
                    var url = '/admin/advisor/'+$e.parents('.row-actions').data('action');

                    var n = new Noty({
                        text: 'Are you sure to delete advisor member',
                        buttons: [
            ...
            $('.add-address').click(function () {
                var $modal = $('#basicModal');
                var url = '/admin/advisor/create';
                axios.get(url).then(function (r) {
                    $modal.find('button[type="submit"] span').html('Add new advisor member');
                    $modal.find('.modal-title').html(r.headers.title);
                    $modal.find('.modal-body').html(r.data);
                    $modal.find('form').attr('action', '/admin/advisor/add');
