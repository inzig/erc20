...
@section('title', 'Referral Transactions | ')

@section('content')
    <h1 class="page-title"> Referral Transactions
        <small>see all referral transactions, approve and send.</small>
    </h1>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                ...
                <a href="javascript:">Referral Transactions</a>
            </li>
        </ul>
    </div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">All pending referral transactions</span>
                </div>
            </div>
