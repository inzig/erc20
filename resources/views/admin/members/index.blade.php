...
@section('content')
    <h1 class="page-title"> Admin Dashboard
        <small>add or update team members</small>
    </h1>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                ...
                <a href="{{ route('admin.team') }}">Members</a>
            </li>
        </ul>
    </div>
    ...
    <div>
        <div class="note note-info">
            <p> Admin must add or update his team members </p>
        </div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Team Members</span>
                </div>
            </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            $datatable.on('click', '.row-actions a[data-action]', function () {
                ...
                var url = '/admin/team/edit/' + $e.parents('.row-actions').data('action');

                if ($type === 'edit')
                    axios.get(url).then(function (r) {
                        $modal.find('button[type="submit"] span').html('Update team member');
                ...
                if($type === 'delete') {
                    var url = '/admin/team/'+$e.parents('.row-actions').data('action');

                    var n = new Noty({
                        text: 'Are you sure to delete team member',
                        buttons: [
            ...
            $('.add-address').click(function () {
                var $modal = $('#basicModal');
                var url = '/admin/team/create';
                axios.get(url).then(function (r) {
                    $modal.find('button[type="submit"] span').html('Add new team member');
                    $modal.find('.modal-title').html(r.headers.title);
                    $modal.find('.modal-body').html(r.data);
                    $modal.find('form').attr('action', '/admin/team/add');
