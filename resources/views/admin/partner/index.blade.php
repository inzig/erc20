...
@section('content')
    <h1 class="page-title"> Admin Dashboard
        <small>add or update partners</small>
    </h1>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                ...
                <a href="{{ route('admin.partner') }}">Partner</a>
            </li>
        </ul>
    </div>
    ...
    <div>
        <div class="note note-info">
            <p> Admin must add or update partners </p>
        </div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Partner</span>
                </div>
            </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            $datatable.on('click', '.row-actions a[data-action]', function () {
                ...
                var url = '/admin/partner/edit/' + $e.parents('.row-actions').data('action');

                if ($type === 'edit')
                    axios.get(url).then(function (r) {
                        $modal.find('button[type="submit"] span').html('Update partner');
                ...
                if ($type === 'delete') {
                    var url = '/admin/partner/' + $e.parents('.row-actions').data('action');

                    var n = new Noty({
                        text: 'Are you sure to delete partner',
                        buttons: [
            ...
            $('.add-address').click(function () {
                var $modal = $('#basicModal');
                var url = '/admin/partner/create';
                axios.get(url).then(function (r) {
                    $modal.find('button[type="submit"] span').html('Add new partner');
                    $modal.find('.modal-title').html(r.headers.title);
                    $modal.find('.modal-body').html(r.data);
                    $modal.find('form').attr('action', '/admin/partner/add');
