...
@section('content')
    ...
    <div>
        <div class="note note-info">
            <p> Admin must add or update business </p>
        </div>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Business</span>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn green"><i class="fa fa-send"></i> <span>Update Business</span></button>
                        </div>
                    </form>
        ...
        jQuery(document).ready(function ($) {
            ...
            $datatable.on('click', '.row-actions a[data-action]', function () {
                ...
                var $modal = $('#basicModal');
                    ...
                    if ($type === 'edit')
                    axios.get('/admin/business/edit/'+$e.parents('.row-actions').data('action')).then(function (r) {
                        $modal.find('button[type="submit"] span').html('Update business');
            ...
            $('.add-address').click(function () {
                var $modal = $('#basicModal');
                axios.get('/admin/business/create').then(function (r) {
                    $modal.find('button[type="submit"] span').html('Add new business ');
                    $modal.find('.modal-title').html(r.headers.title);
                    $modal.find('.modal-body').html(r.data);
                    $modal.modal('show');
                    setTimeout(function () {
            ...
            $('#basicModal').on('submit', 'form', function (e) {
                ...
                axios.patch('/admin/business/add', $e.serialize()).then(function (r) {
                    new Noty({
                        type: r.data.type,
